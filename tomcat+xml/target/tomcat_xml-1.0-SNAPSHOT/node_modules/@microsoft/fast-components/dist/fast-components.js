...
class Search$1 extends Search {
  ...
  appearanceChanged(oldValue, newValue) {
    ...
    DOM.queueUpdate(() => {
      if (newValue === "filled") {
        fillColor.setValueFor(this.root, target => neutralFillRecipe.getValueFor(target).evaluate(target, fillColor.getValueFor(this)).rest);
...
__decorate$1([attr], Search$1.prototype, "appearance", void 0);
/**
...
const fastSearch = Search$1.compose({
  baseName: "search",
  baseClass: Search,
...
const searchStyles$1 = searchStyles;
