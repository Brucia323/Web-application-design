...
<form method="get" action="EditServlet">
    ...
    %>
    <%
        RandomAccessFile randomAccessFile = new RandomAccessFile("huati" + request.getParameter("id") + ".txt", "r");
        String content = new String(randomAccessFile.readLine().getBytes(StandardCharsets.ISO_8859_1), "GBK");
        randomAccessFile.close();
        out.println("内容：<input type='text' name='content' value='" + content + "' required><br>");
    %>
